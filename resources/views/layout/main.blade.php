...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg bg-white shadow-sm py-3 fixed-top">
        <div class="container">
          <a class="navbar-brand fs-5" href="/"><span class="fw-semibold">AlQur'an</span>Ku</a>
   ...
   <section id="footer" class="text-center mt-5 mb-3">
    <div class="fw-300 fs-s-sm">Created By Yasz Avellia</div>
   </section>
